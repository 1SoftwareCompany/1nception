...
public abstract class InceptionOptionsProviderBase<TOptions> :
    ...
    where TOptions : class, new()
{
    ...
    public InceptionOptionsProviderBase(IConfiguration configuration, string name)
    {
        this.configuration = configuration;
        this.Name = name;
    }

    public InceptionOptionsProviderBase(IConfiguration configuration)
