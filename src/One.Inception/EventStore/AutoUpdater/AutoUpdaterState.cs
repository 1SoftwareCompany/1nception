...
using One.Inception.EventStore.AutoUpdater.Events;
...
public record AutoUpdate
{
    ...
    public bool IsSystemUpdate { get; set; } // indicates that this is a inception update or something custom someone wrote.
}
