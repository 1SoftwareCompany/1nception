...
{
    private const string MissingPersistenceMessage = "The Persistence is not configured. Please install a nuget package which provides persistence capabilities such as IEventStoreFactory, IEventStore, IMessageCounter, IEventStorePlayer, IIndexStore. ex.: 1nception.Persistence.Cassandra. You can disable the persistence functionality with Inception:ApplicationServicesEnabled = false";
