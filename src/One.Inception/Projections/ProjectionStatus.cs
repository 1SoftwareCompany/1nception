...
public class ProjectionStatus : IEqualityComparer<ProjectionStatus>, IEquatable<ProjectionStatus>
{
    ...
    /// <summary>
    /// The projection rebuild has timed out because the rebuild process went beyond the allowed <see cref="One.Inception.Projections.Versioning.VersionRequestTimebox"/>
    /// </summary>
