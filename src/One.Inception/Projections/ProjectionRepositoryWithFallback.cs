    ...
    where TFallback : class, IProjectionReader, IProjectionWriter
{
    ...
    {
        isFallbackEnabled = configuration.GetValue<bool>("Inception:projections:fallbackenabled", false) && fallback is null == false;
        useOnlyFallback = configuration.GetValue<bool>("Inception:projections:useonlyfallbackenabled", false) && isFallbackEnabled;
