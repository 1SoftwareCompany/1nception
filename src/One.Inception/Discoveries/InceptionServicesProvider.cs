...
public class InceptionServicesProvider : IInceptionServicesProvider
{
    public InceptionServicesProvider(IServiceCollection services, IConfiguration configuration)
    {
        Services = services;
