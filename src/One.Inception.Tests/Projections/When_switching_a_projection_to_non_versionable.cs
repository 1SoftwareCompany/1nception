...
public class When_switching_a_projection_to_non_versionable
{
    Establish context = () =>
    {
        ...
        var build1 = new ProjectionVersion("NonVersionableProjection", ProjectionStatus.New, 1, "hash");
        var live1 = new ProjectionVersion("NonVersionableProjection", ProjectionStatus.Live, 1, "hash");
        var build2 = new ProjectionVersion("NonVersionableProjection", ProjectionStatus.New, 2, "hash");
        var live2 = new ProjectionVersion("NonVersionableProjection", ProjectionStatus.Live, 2, "hash");
        var build3 = new ProjectionVersion("NonVersionableProjection", ProjectionStatus.New, 3, "hash");
        ...
        nextVersion = new ProjectionVersion("NonVersionableProjection", ProjectionStatus.New, 3, "hash");
    };
